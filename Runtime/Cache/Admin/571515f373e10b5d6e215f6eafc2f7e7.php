                    ...
                    <form id="Form_3">
                        ...
                        <div class="formitems">
                            <table id="goodsparamtable">
                                ...
                                <tr id='param_list'>
                                    <td><input type="text" class="input" name="continuity[]" value="<?php echo ($sign_config["0"]["continuity"]); ?>"/></td>
                                ...
                                <?php if(is_array($sign_config)): $i = 0; $__LIST__ = array_slice($sign_config,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                                        <td><input type="text" class="input" name="continuity[]" value="<?php echo ($info["continuity"]); ?>"/></td>
...
<script>
    ...
    function J_add_param(obj) {
        var html = "<tr>" +
            "<td> <input type=\"text\" class=\"input\" name=\"continuity[]\" /></td>" +
