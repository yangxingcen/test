  ...
  <dl class="left-menu shop_3 sub_tags">
    <?php if(is_array($node_left_list)): foreach($node_left_list as $key=>$v): ?><dt><i class="icon-menu tags"></i> <span id="shop_3" data-id="3"><?php echo ($v['classname']); ?></span></dt>
      <?php if(is_array($v['nodes'])): foreach($v['nodes'] as $key=>$vv): ?><dd class="subshop_0 <?php if(($left_id) == $vv[id]): ?>active<?php endif; ?> ">
        ...
        <div class="content-right fl" style="min-height: 650px;">
            <h1 class="content-right-title">会员概述</h1>
            ...
            <table class="wxtables data mgt15">
                ...
                <thead>
                <tr>
                    <td colspan="10" class="left" style="font-size:14px;">会员概述</td>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td><div class="dataItems">总会员数</div></td>
                    <td><div class="dataItems">今日新增会员</div></td>
                    <td><div class="dataItems">昨日新增会员</div></td>
                    <td><div class="dataItems">过去七天新增会员</div></td>

                </tr>
                <tr>
                    <td><span class="num1"><?php echo ($cache['count']); ?></span></td>
                    <td><span class="num1"><?php echo ($cache['count1']); ?></span></td>
                    <td><span class="num1"><?php echo ($cache['count2']); ?></span></td>
                    <td><span class="num1"><?php echo ($cache['count3']); ?></span></td>
                </tr>
                </tbody>
            </table>
