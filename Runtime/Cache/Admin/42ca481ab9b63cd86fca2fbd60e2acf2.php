  ...
  <dl class="left-menu shop_3 sub_tags">
    ...
    <div class="content-right fl">
      ...
      <form action="" method="get">
                ...
                <input type="text" style="width:120px;" name="title" class="input" placeholder="标题" value="<?php echo ($title); ?>">
  ...
  <div class="jbox-container" style="height: auto;">
    ...
    <div class="formitems">
        ...
        <div class="form-controls pdt5">
            <div class=" fl mgr10">
                <img id="t_img" src="" width="100px" onerror="this.src='http://www.deyishop.com/Public/UploadImg/img/nopic.png'; this.title='图片未找到.'"  onclick="J_uploadImg(this,2)">
...
<script>
    ...
    function update_type(id){
      $.post("<?php echo U('Admin/integral/integral_type_info');?>", {id:id}, function (data) {
    ...
    $("#add_vedio").click(function(){
      ...
      $.post("<?php echo U('Admin/integral/integral_type_addOrUpdate');?>", {array:array,id:id}, function (data) {
          if (data.status == 1) {
    ...
    function del_type(id){
      dialog.showTips("确定要进行删除的操作吗?", "firm", function () {
            $.ajax({
                url: "<?php echo U('Admin/integral/integral_type_del');?>",
                type: "post",
                dataType: "json",
                data: {
                    id:id,
    ...
    $(".change_status").click(function () {
        ...
        dialog.showTips("确定要进行"+title+"的操作吗?", "firm", function () {
            $.post("<?php echo U('Admin/integral/integral_type_status');?>", {id:id,data:data}, function (data) {
                if (data.status == 1) {
                    dialog.showTips(data.info, "", 1);
                    return false;
                } else {
