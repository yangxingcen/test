...
<div class="content-right fl">
    ...
    <form id="search-form" action="<?php echo U('Admin/Goodsorder/index/order_status');?>/<?php echo ($order_status); ?>" method="get">
        <div class="tables-searchbox">
            <input type="text" placeholder="订单编号" class="input newinput" name="name" value="<?php echo I('name');?>">
            <input type="text"  name="starttime" id="starttime" value="<?php echo I('starttime');?>" placeholder="订单起始时间" class="input Wdate" >
            <span class="mgr5">至</span>
            <input type="text"  name="endtime" id="endtime" value="<?php echo I('endtime');?>" placeholder="订单结束时间" class="input Wdate" >
    ...
    <div class="tabs clearfix mgt15">
        <div class="tabs clearfix mgt15">
            <a href="<?php echo U('Admin/Goodsorder/index');?>" class="<?php if(($_GET['order_status']) == ""): ?>active<?php endif; ?> tabs_a fl">所有订单(<?php echo ($count); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/0');?>" class="<?php if(($_GET['order_status']) == "0"): ?>active<?php endif; ?> tabs_a fl">已取消(<?php echo ($count0); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/1');?>" class="<?php if(($_GET['order_status']) == "1"): ?>active<?php endif; ?> tabs_a fl">待付款(<?php echo ($count1); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/2');?>" class="<?php if(($_GET['order_status']) == "2"): ?>active<?php endif; ?> tabs_a fl">待发货(<?php echo ($count2); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/3');?>" class="<?php if(($_GET['order_status']) == "3"): ?>active<?php endif; ?> tabs_a fl">已发货(<?php echo ($count3); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/4');?>" class="<?php if(($_GET['order_status']) == "4"): ?>active<?php endif; ?> tabs_a fl">已完成(<?php echo ($count4); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/5');?>" class="<?php if(($_GET['order_status']) == "5"): ?>active<?php endif; ?> tabs_a fl">已关闭(<?php echo ($count5); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/6');?>" class="<?php if(($_GET['order_status']) == "6"): ?>active<?php endif; ?> tabs_a fl">退款中(<?php echo ($count6); ?>)</a>
            <a href="<?php echo U('Admin/Goodsorder/index/order_status/7');?>" class="<?php if(($_GET['order_status']) == "7"): ?>active<?php endif; ?> tabs_a fl">订单删除(<?php echo ($count7); ?>)</a>
    </div>
      ...
      <table class="wxtables table-order mgt20">
            ...
            <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><thead>
                    <tr>
                        <td colspan="6" class="ftnormal" style="background-color:#F2F8FC;text-align: -webkit-left;">
                            ...
                            <span><?php echo (date("Y-m-d H:i:s",$vo["order_time"])); ?></span>
                            <span class="mgl15">编号：<b class="noteb"><?php echo ($vo["order_no"]); ?></b></span>
                            <span class="mgl20">买家：<b class="noteb"><?php echo ($vo["consignee"]); ?></b></span>
                            <span class="mgl15">电话：<b class="noteb"><?php echo ($vo["mobile"]); ?></b></span>
                            <!--span class="mgl15">
                                <?php switch($vo["order_status"]): case "0": ?>已取消<?php break;?>
                                    <?php case "1": ?><span class="colorRed">待付款</span><?php break;?>
                                    <?php case "2": ?>待成团<?php break;?>
                                    <?php case "3": ?>待发货<?php break;?>
                                    <?php case "4": ?>部分发货<?php break;?>
                                    <?php case "5": ?>待收货<?php break;?>
                                    <?php case "6": ?>待评价<?php break;?>
                                    <?php case "7": ?>已完成<?php break;?>
                                    <?php case "8": ?>申请退款中<?php break;?>
                                    <?php case "9": ?>退款完成<?php break;?>
                                    <?php case "10": ?>拒绝退款<?php break;?>
                                    <?php case "11": ?>申请售后<?php break;?>
                                    <?php case "12": ?>退款关闭<?php break;?>
                                    <?php case "13": ?>前台删除<?php break; endswitch;?>
                            </span-->
                            <span style="margin-right:4px;float:right;">订单总金额：<b class="noteb">¥<?php echo ($vo["total_fee"]); ?></b></span>
                         </td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="pd0">
                            <?php if(is_array($vo["goods"])): $i = 0; $__LIST__ = $vo["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vod): $mod = ($i % 2 );++$i;?><div class="table-item">
                                    <a href="<?php echo U('/Admin/Goods/addGoods/id');?>/<?php echo ($vod["goods_id"]); ?>" class="block" target="_blank" title="<?php echo ($vod["goods_name"]); ?>">
                                        <div class="table-item-img fl">
                                            <img src="<?php echo ($vod["goods_pic"]); ?>">
                                        </div>
                                    </a>
                                    <div class="table-item-info" style="text-align:initial; width:85%">
                                        <p style="height:auto;"><?php echo ($vod["goods_name"]); ?></p>
                                        <p style="height:auto;"><?php echo ($vod["sku_info"]); ?></p>
                                        <span class="price">单价：¥ <?php echo ($vod["goods_price"]); ?> - <?php echo ($vod["goods_integral"]); ?> 积分</span>&nbsp;&nbsp;&nbsp;
                                        <span class="price">数量：<?php echo ($vod["goods_nums"]); ?></span>
                                    </div>
                                    <div class="clear"></div>
                                </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        </td>
                        <td valign="top" style="padding-top:15px;vertical-align: inherit;">
                            <p class="topp mgl15"><b>总&nbsp;&nbsp;金&nbsp;&nbsp;额：¥ <?php echo ($vo["total_fee"]); ?></b></p>
                            <p class="topp mgl15"><b>商品金额：¥ <?php if($vo['total_price']): echo ($vo["total_price"]); else: ?>0.00<?php endif; ?></b></p>
                            <p class="topp mgl15"><b>运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：¥ <?php echo ($vo["express_fee"]); ?></b></p>
                            <p class="topp mgl15"><b>积分抵扣：¥ <?php echo ($vo["use_integral"]); ?></b></p>
                        </td>
                        <td valign="middle" align="center" class="txtCenter">
                            <p><b>
                                <?php switch($vo["pay_way"]): case "1": ?>微信支付<?php break;?>
                                    <?php case "2": ?>支付宝<?php break;?>
                                    <?php case "3": ?>货到付款<?php break; endswitch;?>
                            </b></p>
                            <p><b>¥ <?php if($vo['pay_price']): echo ($vo["pay_price"]); else: ?>0.00<?php endif; ?></b></p>
                            <?php if(!empty($vo['pay_time'])): endif; ?>
                        </td>
                        <td valign="middle" align="center"  class="txtCenter">
                            <p>
                            <?php switch($vo["order_status"]): case "0": ?>已取消<?php break;?>
                                ...
                                <?php case "7": ?>订单删除<?php break; endswitch;?>
                            </p>
                        </td>
                        <td valign="top" style="vertical-align: inherit;">
                            <p>
                                <a href="<?php echo U('Admin/Goodsorder/orderDetail');?>/id/<?php echo ($vo["id"]); ?>" class="btn btn-mini btn-primary">查看详情</a>
                                <!-- 2是已支付需要发货 -->
                                ...
                                <!--后台取消,去支付订单-->
                                <!--代发货start-->
                                <?php if(in_array(($vo['order_status']), explode(',',"3,4"))): ?><a href="javascript:;" 
                                        data-no="<?php echo ($vo["order_no"]); ?>" 
                                        data-id="<?php echo ((isset($vo["id"]) && ($vo["id"] !== ""))?($vo["id"]):0); ?>" 
                                        data-consignee="<?php echo ($vo["consignee"]); ?>" 
                                        data-mobile="<?php echo ($vo["mobile"]); ?>" 
                                        data-address="<?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["district"]); echo ($vo["address"]); ?>"
                                    ...
                                    <a href="javascript:;" 
                                        data-no="<?php echo ($vo["order_no"]); ?>" 
                                        data-id="<?php echo ((isset($vo["id"]) && ($vo["id"] !== ""))?($vo["id"]):0); ?>" 
                                        data-zs="<?php echo ((isset($vo["pay_price"]) && ($vo["pay_price"] !== ""))?($vo["pay_price"]):0); ?>"
                                        data-zj="<?php echo ((isset($vo["use_integral"]) && ($vo["use_integral"] !== ""))?($vo["use_integral"]):0); ?>" 
                                        class="btn btn-mini btn-success a-xstk">线上退款</a><?php endif; ?>
                                <!--代发货end-->
                                <!--申请退款部分-->
...
$(".a-htship").click(function(){
    ...
    $.ajax({
        url: "<?php echo U('Admin/goodsorder/goodslist');?>",
        type: "post",
        dataType: "json",
        data: data,
    }).done(function (g) {
...
$("#fahuo").click(function(){
    ...
    $.ajax({
        url: "<?php echo U('Admin/goodsorder/express');?>",
        type: "post",
        dataType: "json",
        data: data,
    }).done(function (g) {
...
$("#ac-htpay").click(function(){
    if(confirm('确定要执行后台支付吗?')){
        ...
        $.ajax({
            url:"<?php echo U('/Admin/Goodsorder/orderPay');?>",
            type:'post',
            data :data,
            datatype : 'json',
            success:function(g){
...
$("#ac-tuikuan").click(function(){
    ...
    $.ajax({
        url:"<?php echo U('/Admin/Goodsorder/orderRefund');?>",
        type:'post',
        data :data,
        datatype : 'json',
        success:function(g){
...
$(".j-shouhuo").click(function(){
    ...
    //return false;
    $.ajax({
        url:"<?php echo U('/Admin/Goodsorder/receiveOrder');?>",
        type:'post',
        data :data,
        datatype : 'json',
        success:function(g){
