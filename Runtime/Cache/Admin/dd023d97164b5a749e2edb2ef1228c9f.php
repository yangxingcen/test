    ...
    <div class="login-inner">
        ...
        <div class="clearfix mgb10">
            ...
            <div class="code-img fl mgl5">
                <img width="30%" id="vcode" class="left15" height="50" alt="验证码" src="<?php echo U('/Admin/User/verify_c',array());?>" title="点击刷新">
            </div>
        ...
        <div class="login-locationnow">
            <a href="http://www.unohacha.com" style="color:#333;text-decoration:none;" target="_blank">技术支持：吾诺瀚卓</a>
        </div>
    </div>
</div>
<!-- end login -->
<SCRIPT src="/Public/Admin/Js/jQuery1.7.js" type=text/javascript></SCRIPT>
<script type="text/javascript" charset="utf-8" src="/Public/Admin/Js/User/login.js"></script><!--页面js-->
</body>
</html>